...
// it reads correctly at any wider viewport too (see /components/FaqDecorIcons.tsx).
const CANVAS_WIDTH = 343; // ~390px phone viewport minus px-6 padding on each side

let nextId = 0;

export default function ScatterFaqEditor() {
      ...
      <main className="px-6 py-16 mx-auto w-full" style={{ maxWidth: CANVAS_WIDTH + 48 }}>
        ...
        >
          <div className="pointer-events-none text-center">
            ...
            <h1 className="font-heading leading-tight text-foreground text-5xl">Frequently Asked Questions</h1>
          </div>
          {items.map((it) => (
            <img
              key={it.id}
        ...
        <div className="pointer-events-none">
          {questions.length === 0 ? (
            <div className="text-muted-foreground text-center py-20">Loading real FAQ data…</div>
          ) : (
